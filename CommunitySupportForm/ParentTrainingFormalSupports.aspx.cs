...
{
    public partial class ParentTrainingFormalSupports : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = new DataTable();
                cmd.CommandText = "Insert Into dbo.ParentTrainingFormalSupports(ParentSupportType,TargetPopulation,PointOfEntry,OrganizationID)" +
                    "values('" + txtProOff.Text + "','" + txtTarPop.Text + "','" + txtPOE.Text + "','" + txtOrgID.Text + "')";
                cmd.Connection = con;
                cmd.ExecuteNonQuery();
                con.Close();
