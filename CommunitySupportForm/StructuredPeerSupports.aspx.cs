...
{
    public partial class StructuredPeerSupports : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = new DataTable();
                cmd.CommandText = "Insert into dbo.StructuredPeerSupports(PeerType,AgeRange,PeerDescription,PeerAccess,OrganizationID) " +
                    "values('" + txtProOff.Text + "','" + txtTarPop.Text + "','" + txtPOE.Text + "','" + txtAccess.Text + "','" + txtOrgID.Text + "')";
                cmd.Connection = con;
                cmd.ExecuteNonQuery();
                con.Close();
