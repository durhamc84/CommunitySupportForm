...
{
    public partial class YouthLeadership : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                dt = new DataTable();
                cmd.CommandText = "Insert Into dbo.YouthLeadership(YouthLeaderPresent,YouthLeaderDescription,OrganizationID)" +
                    "values('" + txtYouthPres.Text + "','" + txtYouthDesc.Text + "','" + txtOrgID.Text + "')";
                cmd.Connection = con;
                cmd.ExecuteNonQuery();
                con.Close();
